...
if __name__ == '__main__':
    ...
    generate_dir("train", f"{ori_root}hand_dataset/training_dataset/training_data")    # 第一个参数表示生成的文件夹的名称
    generate_dir("test", f"{ori_root}hand_dataset/test_dataset/test_data")
    generate_dir("validation", f"{ori_root}hand_dataset/validation_dataset/validation_data")
